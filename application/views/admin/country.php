 ...
 <head>
  ...
  <div class="col-sm-2"><a href="<?php echo base_url('AdminController/country') ?>"> <button class="butbutton">List Country</button></a></div></div>
        ...
        <?php }?>
         ...
         <div class="row">
                    <div class="col-sm-8">
                 <?php /*if($countrydetail){ foreach ($countrydetail as $cit) {*/
          ?>  
          <!-- <?php //echo $cit['_id'];?> 
          <?php //echo $cit['countryName'];?>
          ...
          <input type="hidden"  name="_id" value="" >
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="countryName" value="" class="form-control col-md-7 col-xs-12" maxlength="25">
                          </div>
                        </div>
                      </div>
    ...
    <!-- page content -->
        ...
        <?php }?>
          ...
          <input type="hidden"  name="_id" value="<?php echo $id;?>" >
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="country" value="<?php echo $pt['countryName']; ?>" class="form-control col-md-7 col-xs-12" maxlength="25">
                        </div>
                        </div>
                      </div>
