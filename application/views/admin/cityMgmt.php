                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="table" class="table table-striped datatable">
                      ...
                      <tbody>
                       <?php $index = 1 ; if($cityList){ foreach($cityList as $u){
                        ...
                        <tr>
                         <!--   <td><?php //echo $index; ?></td> -->
                          ...
                          <td><?php if( $u['status'] == 'Active'){?>
                            <a href="<?php echo base_url();?>AdminController/cityInactive/<?php echo $keyId;?>"><i class="fa fa-toggle-on" style="font-size: 24px;"></i></a>
                            <?php } else {?>
                            <a href="<?php echo base_url();?>AdminController/cityActive/<?php echo $keyId;?>"><i class="fa fa-toggle-off" style="font-size: 24px;"></i></a>
                         <?php }?>
