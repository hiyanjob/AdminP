                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Chat Room Management</h2>
                     <div class="row">
                            ...
                            <div class="col-sm-2"><a href="<?php echo base_url('AdminController/addroom') ?>">
                                <button class="butbutton" >Add Chat Room</button></a>
                            </div>
                          </div>
                  ...
                  <div class="x_content">
                    ...
                    <table id="table" class="table table-striped datatable">
                      ...
                      <!-- <tbody>
                       <?php $index = 1 ; if($roomList){ foreach($roomList as $u){
                        // var_dump($u);die();
                        ...
                        <tr>
                         <!--   <td><?php //echo $index; ?></td> -->
                          ...
                          <td><?php if( $u['status'] == 'Active'){?>
                            <a href="<?php echo base_url();?>AdminController/chatRoomInactive/<?php echo $keyId;?>"><i class="fa fa-toggle-on" style="font-size: 24px;"></i></a>
                            <?php } else {?>
                            <a href="<?php echo base_url();?>AdminController/chatRoomActive/<?php echo $keyId;?>"><i class="fa fa-toggle-off" style="font-size: 24px;"></i></a>
                         <?php }?>
                         <td>
