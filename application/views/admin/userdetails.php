                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="table" class="table table-striped datatable">
                      ...
                      <tbody>
                       <?php $index = 1 ; if($newUser){ foreach($newUser as $usr){
                        // var_dump($u);die();
                        foreach ($usr['_id'] as $keyID) {
                        ?>
                        <tr>
                         <!--   <td><?php //echo $index; ?></td> -->
                          ...
                          <td><?php echo $usr['mobile_no']?$usr['mobile_no']:null; ?></td>
                          <td><?php echo $usr['screenName']?$usr['screenName']:null; ?></td>
                          <td><?php echo $usr['createdAt']; ?></td>
                          
                          <!-- <td><a href="">Block Unblock</a></td>  -->
                          
                          <td><?php if( $usr['status'] == 'Active'){?>
                            <a href="<?php echo base_url();?>AdminController/userInactive/<?php echo $keyID;?>"><i class="fa fa-toggle-on" style="font-size: 24px;"></i></a>
                            <?php } else {?>
                            <a href="<?php echo base_url();?>AdminController/userActive/<?php echo $keyID;?>"><i class="fa fa-toggle-off" style="font-size: 24px;"></i></a>
                         <?php }?>
                          </td>
                          <td> 
                            <button><a href="<?php echo base_url();?>AdminController/jtest/<?php echo $keyID;?>">View</a></button>
                          </td>

                          <td>
                            <!-- <a href="<?php //echo base_url();?>AdminController/addcountry/<?php //echo $keyId;?>"> -->
                              <!-- <i class="fa fa-edit" style="font-size: 22px;"></i></a>&nbsp;&nbsp; -->
                              <a href="<?php echo base_url();?>AdminController/deletusermasters/<?php echo $keyID;?>">
                              <i class="fa fa-trash" style="font-size: 22px;"></i></a>
                          </td> 
                          
                          <!-- <td><a href="<?php //echo base_url();?>AdminController/addpartner/<?php //echo $keyID;?>">Edit</a>|<a href="<?php //echo base_url();?>AdminController/deletepartner/<?php //echo $keyID;?>">Delete</a></td> --> 
                        </tr>
                        <?php  } } }?>
