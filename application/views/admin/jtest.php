                ...
                <div class="x_panel">
                 ...
                 ?> 
                                    <form>
                                      ...
                                      <label for="pp" class="col-sm-2 control-label"><b>Email</b></label>
                                              <div class="col-sm-10">
                                             <?php echo $validusr['email']; ?> 
                                              </div>
                                      </div>

                                      <div class="form-group row">
                                      <label for="pp" class="col-sm-2 control-label"><b>Mobile_No</b></label>
                                              <div class="col-sm-10">
                                              <?php echo $validusr["mobile_no"]; ?>
                                              </div>
                                      </div>

                                      <div class="form-group row">
                                      <label for="pp" class="col-sm-2 control-label"><b>Screen Name</b></label>
                                              <div class="col-sm-10">
                                              <?php echo $validusr['screenName']; ?>
                                              </div>
                                      </div>

                                      <div class="form-group row">
                                      <label for="pp" class="col-sm-2 control-label"><b>Regist.Date</b></label>
                                              <div class="col-sm-10">
                                    ...
                                    <?php }}}?>
                                    <a href="<?php echo base_url('AdminController/user');?>" type="submit"  class="btn btn-primary"><i class="fa fa-angle-left"
